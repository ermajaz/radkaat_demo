...
export default function CustomHotspotMobile({
  hotspot,
}: {
  hotspot: Hotspot;
}) {
  return (
    ...
    >
      <div className="relative flex items-center justify-center">
        ...
        {/* ✅ TEXT */}
        <motion.div
          className="w-[250px] absolute left-30 top-[-60px]"
          initial={{ opacity: 0, y: 6 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.55, duration: 0.45 }}
        >
          <span className="w-full text-sm font-extrabold uppercase text-white leading-tight">
            {hotspot.title}
          </span>
