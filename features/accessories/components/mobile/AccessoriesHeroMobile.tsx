...
export default function AccessoriesHeroMobile() {
    ...
    return (
        ...
        >
            ...
            <motion.div style={{ y: bgY }} className="absolute inset-0">
                <Image
                    src="/images/accessories-hero-img-mobile.png"
                    alt="Radkaat accessories"
                    fill
                    priority
            ...
            >
                ...
                <p className="mt-4 text-[40px] font-serif tracking-wider leading-[1.1] font-semibold">
                    Gear Up.
                    <br />
                    <span className="font-semibold">Ride Smarter.</span>
                </p>

                <p className="mt-4 text-white text-xl max-w-60 mx-auto leading-snug">
                    Precision-built accessories engineered for every ride.
                </p>
            </motion.div>
