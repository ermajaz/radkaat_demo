...
export default function TestRideFlow() {
  ...
  return (
    ...
    >
      ...
      {/* Header */}
      <header className="
  h-20 fixed top-0 left-0 w-full 
...
">
      ...
      {/* Sidebar */}
      <aside className="hidden md:flex flex-col w-80 fixed top-20 left-0 h-[calc(100vh-80px)] p-6 gap-5 border-r border-white/10 backdrop-blur-xl overflow-y-auto scrollbar-thin scrollbar-thumb-sandstorm/60 scrollbar-track-white/10">
          ...
          <AnimatePresence>
            ...
            {selection.bike && (
              <motion.div
                ...
                exit={{ opacity: 0, x: -15 }}
                className="rounded-xl overflow-hidden border border-white/10 bg-black/30 backdrop-blur-lg shadow-lg hover:shadow-xl transition-all"
              >
                ...
                <div className="relative">
                  ...
                  {/* Badge */}
                  <div className="absolute top-3 left-3 bg-superblack/70 px-3 py-1 rounded-md text-xs font-semibold text-sandstorm tracking-wide border border-white/10">
                    Bike Selected
                  </div>
        ...
        ">
            ...
            {selection.store.name && (
              <motion.div
                ...
                animate={{ opacity: 1, x: 0 }}
                exit={{ opacity: 0, x: -15 }}
                className="p-4 rounded-xl border border-white/10 bg-black/30 backdrop-blur-lg shadow-md hover:shadow-lg transition-all flex justify-between"
              >
                <div>
            ...
            {selection.rider && (
              <motion.div
                ...
                animate={{ opacity: 1, x: 0 }}
                exit={{ opacity: 0, x: -15 }}
                className="p-4 rounded-xl border border-white/10 bg-black/30 backdrop-blur-lg shadow-md hover:shadow-lg transition-all flex items-center gap-4"
              >
                <Image
