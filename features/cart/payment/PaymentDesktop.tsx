...
import { CouponSection, PaymentOptions, WalletSection } from "./components";
...
export default function PaymentDesktop() {
  ...
  const handleConfirmPayment = () => {
    ...
    return (
         ...
         <main className="h-full text-white overflow-hidden">
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        {/* RIGHT */}
        <div className="hidden lg:flex w-[45%] bg-linear-to-b from-[#121212] to-black items-center justify-center">
