  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="border border-white/10 bg-white/[0.04] backdrop-blur-lg p-5 flex gap-5 hover:bg-white/[0.07] transition-all cursor-pointer"
        onClick={() => setOpen(true)}
      >
        {/* 🖼️ Image */}
        <div className="relative w-[100px] h-[90px] overflow-hidden flex-shrink-0 bg-[#101010] border border-white/10 flex items-center justify-center">
          <Image
          ...
          >
            ...
            >
              ...
              <div className="relative flex-1 overflow-y-auto max-h-[65vh] scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent">
                ...
                <div className="absolute top-0 left-0 right-0 h-10 bg-gradient-to-b from-[#111] to-transparent pointer-events-none" />
