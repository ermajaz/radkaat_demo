          ...
          <div className="relative flex items-center justify-start w-full">
            ...
            {extraCount > 0 && (
              <motion.div
                ...
                className="absolute left-[160px] w-[80px] h-[80px] bg-white/10 border border-white/20 flex items-center justify-center text-sm text-white/80 backdrop-blur-md"
              >
                +{extraCount} more
              </motion.div>
            )}
