...
export default function OrderDetailsHeader({ order }: { order: Order }) {
  ...
  return (
    <motion.div
      ...
      className="relative overflow-hidden bg-white/[0.06] backdrop-blur-xl border border-white/10 p-6 shadow-lg"
    >
      ...
      {/* Decorative Glow */}
      <motion.div
        className="absolute inset-0 bg-gradient-to-tr from-army/10 via-transparent to-transparent blur-2xl opacity-30 -z-10"
