...
export default function OrderTimeline({ status }: OrderTimelineProps) {
  ...
  return (
    <div className="px-10 sm:px-30 md:px-50 relative mx-auto overflow-hidden bg-gradient-to-br from-[#0f0f0f]/90 via-[#111]/90 to-[#0b0b0b]/90 border border-white/10 p-8 backdrop-blur-xl shadow-[0_0_25px_rgba(0,0,0,0.6)]">
      ...
      <div className="w-full relative flex justify-between items-center">
        {/* Base Line */}
        <div className="absolute top-[30%] left-0 right-0 h-[4px] bg-white/10 rounded-full -translate-y-1/2 z-0" />

        {/* Active Progress */}
        <motion.div
          className="absolute top-[30%] left-0 h-[4px] bg-gradient-to-r from-green-400 via-emerald-400 to-lime-300 rounded-full shadow-[0_0_18px_rgba(34,197,94,0.4)] -translate-y-1/2 z-10"
            ...
            >
              ...
              <motion.div
                ...
                className={`relative flex items-center justify-center w-14 h-14 rounded-full border-2 transition-all duration-300 ${
                  active
                    ? "border-emerald-400 bg-gradient-to-br from-emerald-500/20 to-lime-500/10 shadow-[0_0_20px_rgba(34,197,94,0.3)]"
      ...
      <motion.div
        className="absolute inset-0 -z-10 bg-gradient-to-tr from-emerald-400/5 via-transparent to-transparent blur-3xl"
