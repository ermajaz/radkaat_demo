...
export const OrderSummary: React.FC<OrderSummaryProps> = ({ order }) => {
  ...
  return (
    <motion.div
      ...
      className="relative border border-[#2b2b2b] bg-gradient-to-b from-[#111]/80 to-[#090909]/80 
      backdrop-blur-md p-8 md:p-10 space-y-5 shadow-[inset_0_0_15px_rgba(139,169,137,0.1)]"
    >
      {/* Gradient Line */}
      <div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-army/40 to-transparent" />
