...
export const PaymentStatus: React.FC<PaymentStatusProps> = ({ success }) => {
  return (
    ...
    >
      ...
      <h1 className="text-4xl md:text-5xl font-black uppercase tracking-wide bg-clip-text text-transparent bg-gradient-to-r from-army to-white">
        {success ? "Payment Successful" : "Payment Failed"}
      </h1>

      <p className="text-gray-400 text-base max-w-lg leading-relaxed">
        {success
          ? "Thank you for your purchase! Your order has been confirmed and is being prepared for shipping. Expect a confirmation email shortly."
          : "Unfortunately, your payment could not be processed. Please try again or use an alternate method."}
      </p>
    </motion.div>
  );
};
