...
export default function ProfileInfoCard() {
  ...
  return (
    <motion.div
      className="relative bg-white/[0.05] backdrop-blur-2xl border border-white/10 p-6 shadow-[0_8px_40px_rgba(0,0,0,0.4)]"
    ...
    >
      ...
      <div className="mt-8">
        ...
        <div className="w-full h-2 bg-white/10 overflow-hidden relative rounded-full">
          <motion.div
            ...
            className="h-full bg-gradient-to-r from-army via-sandstorm to-sandstorm-1 rounded-full"
          />
        </div>
      ...
      <motion.div
        className="absolute inset-0 -z-10 bg-gradient-to-tr from-white/10 via-transparent to-transparent blur-3xl opacity-40"
