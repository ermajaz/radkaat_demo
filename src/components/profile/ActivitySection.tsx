...
export default function ActivitySection() {
  return (
    <motion.div
      className="relative bg-white/[0.05] backdrop-blur-2xl border border-white/10 p-6 shadow-[0_8px_40px_rgba(0,0,0,0.4)] space-y-5 overflow-hidden"
    ...
    >
      ...
      <div className="relative mt-4">
        ...
        <motion.div
          className="absolute left-[15px] top-0 bottom-0 w-[2px] bg-gradient-to-b from-white/20 via-white/10 to-transparent"
