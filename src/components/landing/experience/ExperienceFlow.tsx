...
export default function ExperienceFlow() {
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-screen h-screen flex bg-gradient-to-br from-black via-zinc-900 to-black text-white overflow-hidden"
    >
      ...
      <header className="h-20 fixed top-0 left-0 w-full bg-black/80 backdrop-blur-xl border-b border-white/10 z-50 px-6 md:px-10 flex items-center justify-between">
        ...
        <div className="absolute bottom-0 left-0 w-full h-1 bg-white/10 overflow-hidden">
          <motion.div
            className="h-full bg-gradient-to-r from-rust/50 to-rust"
            initial={{ width: 0 }}
