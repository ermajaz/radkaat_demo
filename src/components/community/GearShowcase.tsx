      ...
      {panels.map((panel) => {
        ...
        return (
          <motion.div
            ...
            className="relative flex-shrink-0 flex flex-col justify-end overflow-hidden cursor-pointer group transition-all duration-700"
          >
            {/* Background Image */}
            <motion.div
            ...
            <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-black/80 via-black/30 to-transparent p-6 z-10">
            ...
            <AnimatePresence>
              {isActive && (
                <motion.div
                  ...
                  className="absolute inset-0 bg-gradient-to-b from-black/70 via-black/80 to-black/70 flex flex-col justify-center items-start p-10 z-20"
                >
                  <motion.h3
