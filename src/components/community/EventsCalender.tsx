  ...
  return (
    <section className="relative py-20 px-6 bg-superblack overflow-hidden">
      ...
      {/* <div className="absolute inset-0 -z-10">
        <div className="absolute inset-0 bg-gradient-to-b from-[#0a0a0a] via-[#111519] to-[#0a0a0a]" />
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10">
        {events.map((event, index) => (
          ...
          >
            {/* Glow sweep on hover */}
            <motion.div
              className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-[1.2s]"
            />
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.96 }}
              className="mt-6 inline-flex items-center justify-center gap-2 bg-gradient-to-r from-army/90 via-army to-army/90 cursor-pointer px-6 py-2.5 font-semibold text-black shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:shadow-[0_0_30px_rgba(255,255,255,0.25)] transition-all"
            >
              Join Ride
              <ArrowRight size={18} />
            </motion.button>
            ...
            <motion.div
              className="absolute inset-0 pointer-events-none opacity-0 group-hover:opacity-100 bg-gradient-to-t from-army/10 via-transparent to-transparent transition-all duration-700"
            />
          </motion.div>
        ))}
      </div>
        ...
        {selectedEvent && (
          ...
          >
            ...
            >
              {/* Glow Layer */}
              <motion.div
                className="absolute inset-0 -z-10 bg-gradient-to-tr from-army/15 via-transparent to-sandstorm/10 blur-2xl"
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.96 }}
                className="w-full py-3 bg-gradient-to-r from-army via-sandstorm to-rust text-black font-semibold rounded-xl shadow-[0_0_25px_rgba(255,255,255,0.15)] hover:shadow-[0_0_35px_rgba(255,255,255,0.25)] transition-all"
              >
                Confirm RSVP
              </motion.button>
            </motion.div>
