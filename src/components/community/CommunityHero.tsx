    ...
    >
      ...
      <div className="absolute inset-0 z-10 pointer-events-none">
        {Array.from({ length: 40 }).map((_, i) => (
          <motion.div
            ...
            className="absolute w-[2px] h-[2px] rounded-full bg-sandstorm/40"
          />
        ))}
      </div>
      ...
      >
        <motion.h1
          ...
          className="text-5xl md:text-6xl font-extrabold leading-tight text-transparent bg-clip-text bg-gradient-to-r from-sandstorm via-white to-rust"
        >
          Radkaat Community
        </motion.h1>
        ...
        <motion.button
          ...
          className="group relative inline-flex items-center gap-3 overflow-hidden px-8 py-3 font-semibold text-white bg-gradient-to-r from-rust to-sandstorm cursor-pointer"
        >
