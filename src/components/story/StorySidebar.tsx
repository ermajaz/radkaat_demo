...
export const StorySidebar: React.FC<Props> = ({
  ...
  return (
    <aside className="w-full lg:w-[340px] min-h-[100vh] border-r border-neutral-800/70 bg-gradient-to-b from-[#141414] to-[#0B0B0B] p-6 flex flex-col gap-4 shadow-[inset_-4px_0_12px_rgba(0,0,0,0.3)]">
      {/* Section Title */}
      <motion.h3
          ...
          return (
            <motion.button
              ...
              className={cn(
                ...
                isActive
                  ? "bg-gradient-to-r from-[#1A1A1A] to-[#222]/60 text-white"
      ...
      <div className="mt-auto h-[1px] w-full bg-gradient-to-r from-transparent via-[#E4D27C]/40 to-transparent opacity-60" />
    </aside>
  );
};
