          ...
          <table className="w-full border-collapse">
            ...
            <thead>
              <tr className="border-b border-[#1A1A1A] text-stone text-sm">
                ...
                <th className="font-normal text-right w-[20px]">SM</th>
                <th className="font-normal text-right w-[20px]">MD</th>
                <th className="font-normal text-right w-[20px]">LG</th>
                <th className="font-normal text-right w-[20px]">XL</th>
              </tr>
            </thead>
            ...
            <tbody className="text-base">
              <tr className="border-b border-[#1A1A1A]">
                ...
                <td className="text-right w-[20px]">29</td>
                <td className="text-right w-[20px]">29</td>
                <td className="text-right w-[20px]">29</td>
                <td className="text-right w-[20px]">29</td>
              </tr>
