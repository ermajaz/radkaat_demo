...
export const contactData: SupportSection[] = [
  {
    ...
    content: (
      <div className="space-y-6 bg-gradient-to-r from-navy to-army p-6 rounded-2xl shadow-lg border border-sandstorm-1">
  ...
  },
  {
    ...
    content: (
      <div className="bg-gradient-to-br from-navy via-sandstorm/10 to-army rounded-2xl p-6 shadow-xl border border-sandstorm-1 space-y-4 text-white">
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4 bg-gradient-to-r from-army/90 to-navy/90 p-6 rounded-2xl shadow-md">
        <p className="text-base text-white">
