  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        ...
        <div className="bg-gradient-to-r from-navy to-army p-4 rounded-lg shadow-md text-white text-sm">
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        ...
        <div className="bg-gradient-to-br from-rust to-army p-4 rounded-lg text-sm text-white">
